...
def getAllOrders(connection):
    ...
    for record in response:
        record['order_details'] = getOrderDetails(connection, record['order_id'])
...
def getOrderDetails(connection, order_id):
    cursor = connection.cursor()
...
if __name__ == '__main__':
    ...
    print(getOrderDetails(connection))
